...
def test_input_shape():
    ...
    model, device = image_cinegan.get_cinegan_model()
...
def export_onnx_model():
    ...
    # model, device = image_cinegan.get_fourier_model()

    B, C, H, W =1, 4, 512, 512 # model.MAX_H, model.MAX_W
    model, device = image_cinegan.get_trace_model() # 
    ...
    # }
    onnx_filename = "output/image_cinegan.onnx"
